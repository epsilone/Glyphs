...
namespace Prime31
{
    ...
    // this will pass for iOS and Android when the SocialNetworking Plugin is present
        ...
        public void prepareForMetroUse(GameObject go, MonoBehaviour mb)
        {
            ...
            this.surrogateMonobehaviour = mb;
        }
...
#if UNITY_EDITOR
            if ((this.accessToken != null && this.accessToken.Length > 0) || this.shouldSendRequest())
#else
    ...
    // this will pass for iOS and Android when the SocialNetworking Plugin is present
        ...
        public void graphRequestBatch(IEnumerable<FacebookBatchRequest> requests, Action<string, object> completionHandler)
        {
            ...
            this.surrogateMonobehaviour.StartCoroutine(this.send(string.Empty, HTTPVerb.POST, parameters, completionHandler));
        }
        ...
        public void fetchProfileImageForUserId(string userId, Action<Texture2D> completionHandler)
        {
            ...
            this.surrogateMonobehaviour.StartCoroutine(this.fetchImageAtUrl(url, completionHandler));
        }
        ...
        {
            this.graphRequest("me", (error, obj) =>
            {
                if (completionHandler == null)
                    return;
        ...
        {
            this.graphRequest("me/friends", (error, obj) =>
            {
                if (completionHandler == null)
                    return;
        ...
        public void extendAccessToken(string appId, string appSecret, Action<DateTime?> completionHandler)
        {
            ...
            this.get("oauth/access_token", parameters, (error, obj) =>
            {
                if (obj is string)
                {
		...
		*/
        ...
        {
            this.get("me/permissions", (error, obj) =>
            {
                if (error == null && obj != null && obj is IDictionary)
                {
        ...
        public void postScore(int score, Action<bool> completionHandler)
        {
            ...
            this.post("me/scores", parameters, (error, obj) =>
            {
